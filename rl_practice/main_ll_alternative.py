...
import gym
from dqn_lunar_lander_alternative import Agent
import numpy as np
from tqdm import tqdm


def plotLearning(x, scores_hist, epsilons, filename, lines=None):
    """
...
if __name__ == "__main__":
    ...
    agent = Agent(gamma=0.99, epsilon=1.0, batch_size=64, n_actions=4,
                  eps_end=0.01, input_dims=[8], learning_rate=0.003)
    scores, eps_history = [], []
    NUM_GAMES = 500
    ...
    filename = "lunar_lander_plot.png"
